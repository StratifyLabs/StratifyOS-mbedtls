...
int sha256_init(void ** context){
	mbedtls_crypt_sha256_context_t * c = malloc(sizeof(mbedtls_crypt_sha256_context_t));
	if( c == 0 ){ return -1; }
...
int sha512_init(void ** context){
	mbedtls_crypt_sha512_context_t * c = malloc(sizeof(mbedtls_crypt_sha512_context_t));
	if( c == 0 ){ return -1; }
